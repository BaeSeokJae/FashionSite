...
if ($page != 1) {
    $paging .= '<li class="page page_start"><a href="./daily_board.php?page=1"><img src="image/page_pprev.png"/></a></li>';
}

//첫 섹션이 아니라면 이전 버튼을 생성
if ($currentSection != 1) {
    $paging .= '<li class="page page_prev"><a href="./daily_board.php?page=' . $prevPage . '">이전</a></li>';
}
...
for ($i = $firstPage; $i <= $lastPage; $i++) {
    if ($i == $page) {
        ...
        $paging .= '<li class="page"><a href="./daily_board.php?page=' . $i . '">' . $i . '</a></li>';
    }
}

//마지막 섹션이 아니라면 다음 버튼을 생성
if ($currentSection != $allSection) {
    $paging .= '<li class="page page_next"><a href="./daily_board.php?page=' . $nextPage . '">다음</a></li>';
}

//마지막 페이지가 아니라면 끝 버튼을 생성
if ($page != $total_page) {
    $paging .= '<li class="page page_end"><a href="./daily_board.php?page=' . $total_page . '"><img src="image/page_nnext.png"/></a></li>';
}
    ...
    <div id="outer">
        ...
        <div id="main">
            <div id="contentlist">
                ...
                <h4>데일리룩에서 '<?php echo $search_con; ?>'검색결과 입니다.</h4>
                <thead align="center">
                </thead>
                <div id="thumbnailBox">
                        ...
                        <?php foreach ($list as $row) : ?>
                            ...
                            <div class="cell" style="width: auto;  height: auto;">
                                ...
                                <?php if ($row['daily_board_reply_count'] == 0) { ?>
                                    <div width="100" align="center" style="font-size: 20px; margin: 10px"><?php echo($row['title']); ?>
                                    </div>
                                <?php } else { ?>
                                    <div width="100" align="center"
                                         style="font-size: 20px; margin: 10px"><?php echo($row['title']); ?> <strong class="reply">(<?php echo $row['daily_board_reply_count'] ?>)</strong>
                                    </div>
                                <?php } ?>
                                <div>
                                    <hr/>
                                ...
                                <div width="100" align="center"
                                     style="font-size: 15px; margin-top: 10px; margin-left: 10px; margin-right: 10px">
                                    조회수 : (<?php echo($row['hit']); ?>)
                                </div>
                                <div width="100" align="center" style="font-size: 15px">작성자
                                    : <?php echo($row['id']); ?></div>
                                <div width="100" align="center" style="font-size: 15px">추천수
                ...
                <form action="daily_write.php" method="get">
                    <div class=text>
                        ...
                        <input type="submit" value="글쓰기" name="submit" style="margin: .9em">
                    </div>
                </form>
                <div class="paging">
                    <style>
