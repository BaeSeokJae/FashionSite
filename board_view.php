...
$sql5 = "select * from board_reply where status = 'Y' AND ready_status = 'Y'";
        ...
        <div id="main">
            ...
            <div id="contentlist">
                ...
                <div class="reply_view">
                    <div>
                        <h3>댓글목록</h3>
                        <p>총 댓글수 ( <?php echo $reply_count ?> )</p>
                    </div>
                    <?php
                                    ...
                                    <?php if ($reply['reply_number'] == $row1['re_reply_number']) { ?>
                                        <div class="re_reply">
                                            <?php if ($rows['id'] == $row1['id']) { ?>
                                                <div><b>re-> <?php echo $row1['id']; ?> (작성자) </b></div>
                                            <?php } else { ?>
                                                <div>
                                                    <img src="image/re_reply.png" style="width: 20px; height: 20px; padding-top: 5px;">
