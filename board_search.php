...
if ($currentSection != 1) {
    $paging .= '<li class="page page_prev"><a href="./board_search.php?category=' . $category . '&search_con=' . $search_con . '&page=' . $prevPage . '">이전</a></li>';
}
...
if ($currentSection != $allSection) {
    $paging .= '<li class="page page_next"><a href="./board_search.php?category=' . $category . '&search_con=' . $search_con . '&page=' . $nextPage . '">다음</a></li>';
}
    ...
    <div id="outer">
        ...
        <div id="main">
            <div id="contentlist">
                ...
                <h4>게시판에서 '<?php echo $search_con; ?>'검색결과 입니다.</h4>
                <table align=center>
                    <thead align="center">
                    <tr>
                ...
                <div class=text align="right">
                    <span style="cursor: hand" onClick="location.href='board_write.php'">글쓰기</span>
                </div>
                <br>
                <div class="paging">
                    <style>
                ...
                <div id="search_box2">
                    <form action="board_search.php" method="get">
                        ...
                        <input type="text" name="search_con" size="40" required="required"/><button>검색</button>
                    </form>
                </div>
            </div>
        </div>
