    ...
    <div id="outer">
        ...
        <div id="main">
            <div id="contentlist">
                ...
                <h2 align=center style="border-bottom: solid 1px gray; margin: 0 0 0 0; padding: 0 0 20px 0">데일리룩</h2>
                <thead align="center">
                </thead>
                <div id="thumbnailBox">
                        ...
                        <?php foreach ($list as $row) : ?>
                            ...
                            <div class="cell" style="width: auto;  height: auto;">
                                ...
                                <div width="100" align="center"
                                     style="font-size: 20px; margin: 10px; padding: 0 0 10px 0; border-bottom: solid 1px gray"><?php echo($row['title']); ?>
                                </div>
                                <?php } else { ?>
                                <div width="100" align="center"
