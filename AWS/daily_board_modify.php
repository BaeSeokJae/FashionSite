...
<!--            <a href="#">아이디 / 비밀번호 찾기</a>-->
        ...
        <div id="main">
            <div id="contentlist">
                ...
                $query1 = "select * from daily_board where board_num = '$board_num'";
                ...
                $hit = $rows['hit'];
                $status = $rows['status'];
                $daily_board_reply_count = $rows['daily_board_reply_count'];
                ...
                ?>
                <form method="post" action="daily_board_modify_action.php" enctype="multipart/form-data">
                        ...
                        <tr>
                            <td bgcolor=white>
                                            ...
                                            <div>
                                                <div class="imgs_wrap">
                                                    ...
                                                    while ($row1 = mysqli_fetch_assoc($result1)) { ?>
                                                        <a><?php echo '<img src=' . $row1['imgurl'] . '></a>' ?>
                                                    <?php } ?>
                                                </div>
                                ...
                                <center>
                                    ...
                                    <input type="hidden" name="daily_board_reply_count" value="<?= $daily_board_reply_count ?>">
