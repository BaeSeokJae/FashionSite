...
<div id="bg">
    <div id="outer">
        ...
        <div id="main">
            ...
            <div class=box5
                 style="background-position: 0% 0%; margin: 0px 0px 20px 20px; border: 0px solid rgb(221, 221, 221); width: 405px; height: 260px; float: left; background-image: none; background-repeat: repeat; background-color: rgb(255, 255, 255);">
            </div>
            <!--            </div>-->
        </div>
        <div id="copyright">
